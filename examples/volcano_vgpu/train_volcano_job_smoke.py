...
- NODE_RANK 来自 Volcano env 插件 VK_TASK_INDEX
...
def main():
    ...
    node_rank = int(os.environ.get("VK_TASK_INDEX", os.environ.get("NODE_RANK", "0")))
    ...
    if logger is not None:
        ...
        logger.report_text(
            "Volcano Job smoke: sum=%s expected=%s ok=%s MASTER_ADDR=%s VK_TASK_INDEX=%s"
